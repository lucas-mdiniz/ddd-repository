...
import NotifyWhenAddressIsUpdatedHandler from "../../customer/event/handler/notify-when-address-is-updated";
import NotifyWhenCustomerIsCreatedHandler1 from "../../customer/event/handler/notify-when-customer-is-created-1";
import NotifyWhenCustomerIsCreatedHandler2 from "../../customer/event/handler/notify-when-customer-is-created-2";
